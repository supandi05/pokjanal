  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_content">  
            <h3><a href="tambah_galeri.php" class="btn btn-success">Tambahkan</a></h3>
              ...
              if ($result->num_rows != 0) { // menghitung jumlah rows / baris
                ...
                while($row = $result->fetch_assoc()) {
                  echo '<tr>';
                  echo'<td>'.$no.'</td>';
                  echo'<td><img src="asset/images/galeri/'.$row['nama_foto'].'" width="50px"></td>';
                  echo'<td>'.$row['tgl_foto'].'</td>';
                  echo'<td>'.$row['keterangan_foto'].'</td>';
                  echo '<td><a href="edit_galeri.php?id='.$row['id_galeri']. '">Edit</a> /
                        <a href="hapus_galeri.php?id='.$row['id_galeri']. '" onclick="return confirm(\'Anda Yakin Ingin Menghapus Data?\')">Hapus</a></td>';
                  echo '</tr>';
                  $no++;
                }
              } else {
