      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            <form method="post" action="pro_editgaleri.php" id="demo-form2" data-parsley-validate enctype="multipart/form-data" class="form-horizontal form-label-left">
                <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tgl">Tanggal Foto<span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="date" id="tgl_foto" name="tgl_foto" required="required" value="<?php echo $tgl; ?>" class="form-control col-md-7 col-xs-12"> 
                    <input type="hidden" id="id" name="id" required="required" value="<?php echo $id; ?>" class="form-control col-md-7 col-xs-12">             
            
                  </div>
              </div> 
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Foto<span ></span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <img src="asset/images/galeri/<?php echo $nama; ?>" height="150px"><br>
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sejarah">Keterangan Foto<span ></span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea border="5" class="summernote" name="keterangan" value="" placeholder="Ketik berita disini..." value=""><?php echo $keterangan; ?></textarea>
                  </div>
              </div>       
