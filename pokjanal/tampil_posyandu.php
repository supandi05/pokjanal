  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_content">  
            <h3><a href="tambah_posyandu.php" class="btn btn-success">Tambahkan</a></h3>
              ...
              $sql = "SELECT * FROM data_posyandu order by nama_posyandu asc"; // syntax SQL
              ...
              if ($result->num_rows != 0) { // menghitung jumlah rows / baris
                ...
                while($row = $result->fetch_assoc()) {
                  echo '<tr>';
                  echo'<td>'.$no.'</td>';
                  echo'<td>'.$row['nama_posyandu'].'</td>';
                  echo'<td>'.$row['lokasi_posyandu'].'</td>';
                 echo'<td>'.$row['waktu_layanan'].'</td>';
                  echo '<td><a href="edit_posyandu.php?id='.$row['id_posyandu']. '">Edit</a> /
                        <a href="hapus_posyandu.php?id='.$row['id_posyandu']. '" onclick="return confirm(\'Anda Yakin Ingin Menghapus Data?\')">Hapus</a></td>';
                  echo '</tr>';
                  $no++;
                }
              } else {
