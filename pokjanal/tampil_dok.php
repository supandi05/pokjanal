  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_content">  
            <h3><a href="tambah_dok.php" class="btn btn-success">Tambahkan</a></h3>
              ...
              $sql = "SELECT * FROM dokumen"; // syntax SQL
              ...
              if ($result->num_rows != 0) { // menghitung jumlah rows / baris
                ...
                while($row = $result->fetch_assoc()) {
                  echo '<tr>';
                  echo'<td>'.$no.'</td>';
                  echo'<td>'.$row['tgl_dok'].'</td>';
                  echo'<td>'.$row['nama_dok'].'</td>';
                  echo'<td>'.$row['keterangan_dok'].'</td>';
                  echo '<td><a href="edit_dok.php?id='.$row['id_dok']. '">Edit</a> /
                        <a href="hapus_dok.php?id='.$row['id_dok']. '" onclick="return confirm(\'Anda Yakin Ingin Menghapus Data?\')">Hapus</a></td>';
                  echo '</tr>';
                  $no++;
                }
              } else {
