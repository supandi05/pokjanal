...
<head>
    ...
    <!-- Title  -->
    <title>Dokumen | POKJANAL KEC. CIMALAKA</title>
                                ...
                                <?php
                                  ...
                                  if ($result->num_rows != 0) { // menghitung jumlah rows / baris
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        $namafile = $row['nama_dok'];
                                      echo '<tr>';
                                      echo'<td>'.$no.'</td>';
                                      echo'<td>'.$row['nama_dok'].'</td>';
                                      echo'<td>'.$row['keterangan_dok'].'</td>';
                                      ?>
                                      <!--echo'<td><a href="download.php?filename='.$namafile.'"</td>'; -->
                                      <td><a href="download.php?filename=<?php echo $row['nama_dok'] ?>">Download</a></td>
