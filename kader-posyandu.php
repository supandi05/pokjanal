...
<head>
    ...
    <!-- Title  -->
    <title>Kader Posyandu| POKJANAL KEC. CIMALAKA</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-left wow fadeInUp" data-wow-delay="250ms">
                        <h3>DATA KADER POSYANDU KECAMATAN CIMALAKA</h2>
                        ...
                        <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                  ...
                                  $sql = "SELECT * FROM data_kader"; // syntax SQL
                                  ...
                                  if ($result->num_rows != 0) { // menghitung jumlah rows / baris
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                      $jk = $row['jk_kader']=="l"?"Laki-Laki":"Perempuan";
                                      echo '<tr>';
                                      echo'<td>'.$no.'</td>';
                                      echo'<td>'.$row['nama_kader'].'</td>';
                                      echo'<td>'.$jk.'</td>';
                                      echo'<td>'.$row['jabatan_kader'].'</td>';
                                      echo'<td>'.$row['id_posyandu'].'</td>';                                     
                                      echo '</tr>';
                                      $no++;
                                    }
                                  } else {
