...
<head>
    ...
    <!-- Title  -->
    <title>Profil | POKJANAL KEC. CIMALAKA</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8">
                    <div class="text-left wow fadeInUp" data-wow-delay="250ms">
                        
                        <br>
                        <img class="wow fadeInUp" data-wow-delay="350ms" src="img/bg-img/kantor-kecamatan-cimalaka.jpeg" alt="">
                        ...
                        <p>
                             <?php
                                  ...
                                  $sql = "SELECT * FROM profil WHERE judul='sejarah'"; // syntax SQL
                        ...
                        <p> Upaya Lesehatan Bersumber Daaya Masyarakat yang selanjutnya disingkat UKBM adalah wahana pemberdayaan masyarakat yang dibentuk atas dasar kebutuhan masyarakat, dikelola oleh, dari, untuk dan bersama masyarakat, dengan bimbingan dari petugas Pusat Kesehatan Masyarakat, lintas sektor dan lembaga terkait lainnya.</p>
                        <p>Kelompok Kerja Opersional Pembinaan Pos Pembinaan dan Pelayanan Terpadu yang selanjutnya disebut Pokjanal Posyandu adalah Kelompok kerja yang tugas dan fungsinya mempunyai keterkaitan dalam pembinaan penyelenggaraan/pengelolaan Posyandu yang berkedudukan di Pusat, Provinsi, Kabupaten/Kota dan Kecamatan.
                        </p>
                        <p> Kelompok Kerja Posyandu yang selanjutnya disebut Pokja Posyandu adalah kelompok kerja yang tugas dan fungsinya mempunyai keterkaitan dalam pembinaan penyelenggaraan/pengelolaan Posyandu yang berkedudukan di Desa.
                        </p>
                        <p> Kader Posyandu adalah anggota masyarakat yang dipilih, bersedia, mampu, dan memiliki waktu untuk mengelola kegiatan Posyandu. </p>
                    </div>
                </div>
